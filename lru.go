...
// callback.
func NewWithEvict(size int, onEvicted func(key int64, value simplelru.VersionedValue)) (*Cache, error) {
...
func (c *Cache) Get(key int64) (simplelru.VersionedValue, bool) {
	c.lock.Lock()
	defer c.lock.Unlock()
...
func (c *Cache) Peek(key int64) (simplelru.VersionedValue, bool) {
	c.lock.RLock()
	defer c.lock.RUnlock()
